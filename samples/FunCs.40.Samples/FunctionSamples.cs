namespace FunCs.Samples
{
    ...
    public partial class FunctionSamples
    {
        ...
        public void VeryBasicUsage()
        {
            ...
            // But this does:
            var square = Fun.function((int x) => x * x);
        ...
        public void TheTypeOfLambda()
        {
            ...
            var fWithZeroArgs = Fun.function(() => 10);
            var fWithOneArgs = Fun.function((int x1) => x1);
            var fWithTwoArgs = Fun.function((int x1, int x2) => x1*x2);
